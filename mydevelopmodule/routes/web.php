...
Route::get('/history', 'PagesController@getHistoryPage')->name('history');
Route::get('/search',['uses'=>'SearchController@getSearchData', 'as'=>'get.search']);
Route::get('/search/bygroup',['uses'=>'SearchController@getSearchDataByGroup', 'as'=>'get.searchbygroup']);
Route::get('/search/bydate',['uses'=>'SearchController@getSearchDataByDate', 'as'=>'get.searchbydate']);
